...
b_input			equ 0x0000000000100010	; Take string from keyboard entry. IN: RDI = location where string will be stored. RCX = max chars to accept
b_output		equ 0x0000000000100018	; Displays text. IN: RSI = message location (zero-terminated string)
